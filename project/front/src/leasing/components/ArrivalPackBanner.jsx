              ...
              <ul className="mb-3 space-y-2">
                {packData.products.length === 0 ? (
                  ...
                  packData.products.map((p) => (
                    <li
                      key={p.id}
                      className="flex items-center gap-3 text-xs text-gray-700 bg-gray-50/50 p-1 rounded border border-gray-100"
                    >
                      <img
                        src={
                          p.firstImageUrl ||
                          fallbackImage(p.category || "Produit")
                        }
                        alt={p.postTitle}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span className="truncate block text-[9px] text-gray-500">
                          {p.category}
                        </span>
                      </div>
                      <span className="material-symbols-rounded text-[16px] text-green-600 mr-1">
                        check_circle
                      </span>
                    </li>
                  ))
