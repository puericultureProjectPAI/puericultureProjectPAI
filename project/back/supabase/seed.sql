...
INSERT INTO public.products (author_id, post_title, description, category, city, condition, brand, dimensions, min_age_months, max_age_months, max_weight_kg) VALUES
    ...
    ('00000000-0000-0000-0000-000000000001', 'Siège auto groupe 0+',         'Siège auto homologué ECE R44/04, coque rigide, harnais 5 points.',                    'Siège auto', 'Lyon',      'Bon état',       'Maxi-Cosi',    '64x43x60 cm',  0,  12, 13),
    ('00000000-0000-0000-0000-000000000001', 'Berceau co-dodo',              'Berceau fixable au lit parental, matelas inclus, structure bois.',                     'Couchage',   'Bordeaux',  'Excellent état', 'Chicco',       '93x43x78 cm',  0,   6, NULL),
    ('00000000-0000-0000-0000-000000000001', 'Transat vibrant Fisher-Price', 'Transat à vibrations douces, arche de jeux amovible, 3 positions.',                   'Transat',    'Paris',     'Bon état',       'Fisher-Price', '75x53x58 cm',  0,   6, 11),
    ('00000000-0000-0000-0000-000000000001', 'Trotteur évolutif',            'Trotteur réglable en hauteur, plateau d''activités, roues antidérapantes.',            'Éveil',      'Marseille', 'État correct',   'Chicco',       '68x46x52 cm',  6,  15, 11),
    ('00000000-0000-0000-0000-000000000001', 'Baignoire bébé ergonomique',   'Baignoire avec support antidérapant et thermomètre intégré, 0-24 mois.',              'Bain',       'Nantes',    'Excellent état', 'Thermobaby',   '82x46x23 cm',  0,  24, NULL);
