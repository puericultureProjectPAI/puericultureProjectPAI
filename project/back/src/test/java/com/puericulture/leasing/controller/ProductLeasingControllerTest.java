...
class ProductLeasingControllerTest {
    ...
    @Mock private ProductLeasingService productLeasingService;

    @InjectMocks private ProductLeasingController productLeasingController;
    ...
    void setUp() {
        mockMvc =
                MockMvcBuilders.standaloneSetup(productLeasingController)
