 ...
 * <p>
 * Cette classe utilise l'annotation {@link RestControllerAdvice} pour intercepter
 * les exceptions levées par n'importe quel component de l'application et les
 * transformer en réponses HTTP au format JSON.
 */
...
public class CustomGlobalExceptionHandler {
    ...
    /**
     * Gère les défauts d'authentification (401).
     * Force le type de contenu en JSON pour garantir la structure de la réponse.
    ...
    /**
     * Filet de sécurité final (500).
     * Capture toutes les exceptions non traitées spécifiquement.
